CREATE DATABASE  IF NOT EXISTS `waitnahi` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `waitnahi`;
-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)
--
-- Host: localhost    Database: waitnahi
-- ------------------------------------------------------
...
INSERT INTO `developer` VALUES (1,'Pramod Maurya','JAVA'),(2,'Satish Kejriwal','JAVA'),(3,'Ankit','Android');
...
INSERT INTO `user` VALUES (1,'admin@admin.com','','2016-01-01 00:00:00','$2a$08$lDnHPz7eUkSi6ao14Twuau08mzhWrL4kyZGGU5xfiGALO/Vxd5DOi','admin'),(2,'enabled@user.com','','2016-01-01 00:00:00','$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC','user');
...
-- Dump completed on 2017-04-18 18:07:25
